...
export default function Siemens7UT86Slope({ onBack }) {
  ...
  const calculateSlope = () => {
    ...
    const y1 = Pickup;
    const x2 = Point2;
    const y2 = Slope1 * (Point2 - Point1) + Pickup;
    const x3 = (Highset - y2) / Slope2 + Point2;
    const y3 = Highset;
    ...
    <div className="calculator-container">
      <div className="calculator-header">
        <div className="calculator-header-content">
          ...
          <h1 className="calculator-title">Siemens 7UT86 Slope</h1>
        ...
        {graphData.length > 0 && (
          <div className="calc-chart-container">
            ...
            <ResponsiveContainer width="100%" height={320}>
              ...
              >
                <defs>
                  <linearGradient id="colorArea86" x1="0" y1="0" x2="0" y2="1">
